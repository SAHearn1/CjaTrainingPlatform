...
- [ ] **Repo confirmed:** You are operating in `SAHearn1/CjaTrainingPlatform` (Tier 1 — production-critical)
...
- [ ] **Active incidents checked:** `docs/INCIDENTS.md` reviewed — list any open incidents relevant to the current task
